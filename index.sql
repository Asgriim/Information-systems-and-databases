...
CREATE INDEX IF NOT EXISTS content_tags_id_ind ON content_tags USING hash (tag_id);
CREATE INDEX IF NOT EXISTS content_tags_content_ind ON content_tags USING hash (content_id);
